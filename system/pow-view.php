...
//
$_CONFIG['main_title'] = "View POW CMS Content";
...
//
$_CONFIG['secondary_titles'] = array("Shows Only Content Files - No System Files");
...
//
$_CONFIG['hidden_dirs'] = array('system','res');
...
//
$_CONFIG['hidden_files'] = array(".ftpquota", "index.php", "index.php~", ".htaccess", ".htpasswd", "shttpd.exe", "shttpd.conf", "CopyFiles.bat", "CreateDistribution.bat", "load.htm", "pow-edit.php", "pow-search.htm", "pow-config.php",  "pow-view.php", "pow-scan.php", "pow-custom.php", "pow-word.php", "pow-update.php", "pow-login.php", "pow-scan.php", "pow-config.php", "index_vars.js", "pow_vars.js", "index_vars.js", "index.htm", "index.html", "info.htm", "side-folders.htm", "side-links.htm", "side-pages.htm", "search_vars.txt", "search_tags.txt");
